...
class FMapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        solicitarPermisos()
        var peliculaMapa = intent.getSerializableExtra("pelicula") as Pelicula
        ...
        fragmentoMapa.getMapAsync { googleMap ->
            if (googleMap != null) {
                ...
                val pelicula = LatLng(peliculaMapa.latitud, peliculaMapa.altitud)
                val titulo = peliculaMapa.nombre.toString()
                val zoom = 17f
